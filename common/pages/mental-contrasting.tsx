...
// @ts-ignore
import featured from './img/mental-contrasting.jpg'
...
export default defineLesson({
    ...
    subtitle: "People are more motivated when they consider a desired future in contrast with obstacles in the present",
