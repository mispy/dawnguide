...
// @ts-ignore
import baCycle from './img/behavioral-activation-cycle.png'
...
export default defineLesson({
    ...
    subtitle: "Scheduling meaningful activities in defiance of avoidant feelings helps to defeat depression",
